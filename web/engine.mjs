...
function _M0DTPC16result6ResultGjRPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGjRPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGjRPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGjRPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
...
function _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(self, value) {
...
function _M0MPB4Iter9to__arrayGRPC16string10StringViewE(self) {
  ...
  while (true) {
    ...
    if (_bind$2 === undefined) {
      ...
      const _Some = _bind$2;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(result, _x);
      continue;
    }
  }
  return result;
...
function _M0MPC15array5Array5makeiGRP211localreview5faker7ProfileEHRP211localreview5faker9FakeError(length, f) {
  ...
  return new _M0DTPC16result6ResultGRPB5ArrayGRP211localreview5faker7ProfileERP211localreview5faker9FakeErrorE2Ok(_tmp);
}
...
function _M0MPC15array5Array5makeiGiEHRP211localreview5faker9FakeError(length, f) {
  ...
  return new _M0DTPC16result6ResultGRPB5ArrayGiERP211localreview5faker9FakeErrorE2Ok(_tmp);
}
function _M0MPC15array5Array5makeiGsEHRP211localreview5faker9FakeError(length, f) {
  ...
  return new _M0DTPC16result6ResultGRPB5ArrayGsERP211localreview5faker9FakeErrorE2Ok(_tmp);
}
...
function _M0MPB3Map20add__entry__to__tailGsbE(self, idx, entry) {
  ...
  if (_bind === -1) {
    ...
    _M0MPC16option6Option6unwrapGRPB5EntryGsbEE(_bind >>> 0 < _tmp.length ? _tmp[_bind] : $oob()).next = entry;
  }
  self.tail = idx;
...
function _M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(self) {
...
function _M0MPC15array5Array3popGRPC14json10WriteFrameE(self) {
  if (_M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(self)) {
    return undefined;
  } else {
...
function _M0MPC15array5Array6filterGsE(self, f) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0MPC15array5Array10push__iterGsE(self, iter) {
  ...
  while (true) {
    ...
    if (_bind$2 === undefined) {
      ...
      const _Some = _bind$2;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(self, _x);
      continue;
    }
  }
}
...
function _M0MPC15debug4Repr6record(fields) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _name = _x._0;
      const _value = _x._1;
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_acc, new _M0DTPC15debug4Repr11RecordField(_name, _value));
      continue;
    }
  }
...
function _M0FPC15debug15surround__lines(start, finish, lines) {
  if (lines.length === 0) {
    ...
    if (lines.length === 1) {
      ...
      const _self = [];
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_self, `${start}${_first}`);
      _M0MPC15array5Array10push__iterGsE(_self, _M0MPC15array9ArrayView4iterGsE(_x));
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_self, `${_last}${finish}`);
      return _self;
    }
  }
}
      ...
      if (_first === "[" && _last === "]" || _first === "{" && _last === "}") {
        ...
        while (true) {
          ...
          if (_ < _bind) {
            ...
            if (_M0IP016_24default__implPB2Eq10not__equalGRPC16string10StringViewE(t, new _M0TPC16string10StringView(_M0FPC15debug14compact__linesN7_2abindS1134, 0, _M0FPC15debug14compact__linesN7_2abindS1134.length))) {
              _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(parts, t);
            }
            _tmp = _ + 1 | 0;
            continue;
          } else {
        ...
        if (_M0MPC16string6String11has__suffix(_first, new _M0TPC16string10StringView(_M0FPC15debug14compact__linesN7_2abindS1148, 0, _M0FPC15debug14compact__linesN7_2abindS1148.length)) && _last === ")") {
          ...
          while (true) {
            ...
            if (_ < _bind) {
              const m = lines[1 + _ | 0];
              _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(parts, _M0MPC16string6String4trim(m, undefined));
              _tmp = _ + 1 | 0;
              continue;
            } else {
              break;
          ...
          _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(parts, _M0MPC16string6String4trim(_last, undefined));
  ...
  if (contents.length === 0) {
    ...
    if (contents.length === 1) {
      ...
      if (_item.length > 1) {
        ...
        if (!_M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(lines)) {
        ...
        const _self = [];
        _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_self, open);
        _M0MPC15array5Array10push__iterGsE(_self, _M0MPC15array5Array4iterGsE(lines));
        _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_self, close);
        return _self;
      } else {
        ...
        if (_ < _bind) {
          ...
          if (item_lines.length === 0) {
            ...
            if (item_lines.length === 1) {
              ...
              _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(out, `${_M0MPC16string6String6repeat(" ", indent_by)}${_x},`);
            } else {
              const _first = item_lines[0];
              const _last = item_lines[item_lines.length - 1 | 0];
              const _x_end = item_lines.length - 1 | 0;
              _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(out, `${_M0MPC16string6String6repeat(" ", indent_by)}${_first}`);
              ...
              while (true) {
                ...
                if (_$2 < _bind$2) {
                  ...
                  _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(out, `${_M0MPC16string6String6repeat(" ", indent_by)}${mid}`);
                  _tmp$2 = _$2 + 1 | 0;
                  continue;
                } else {
                  break;
              ...
              _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(out, `${_M0MPC16string6String6repeat(" ", indent_by)}${_last},`);
            }
          }
          _tmp = _ + 1 | 0;
          continue;
      ...
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(out, close);
      return out;
    }
  }
}
          ...
          if (contents.length === 1) {
            ...
            if (item_lines.length === 0) {
              ...
              if (item_lines.length === 1) {
                ...
                const _self = [];
                _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_self, begin);
                ...
                _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_self, `${_M0MPC16string6String6repeat(" ", 2)}${_last_line},`);
                _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_self, end);
                return _self;
              }
            }
          } else {
            ...
            while (true) {
              ...
              if (_ < _bind) {
                ...
                if (item_lines.length === 0) {
                  ...
                  if (item_lines.length === 1) {
                    const _x = item_lines[0];
                    _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(out, `${_M0MPC16string6String6repeat(" ", 2)}${_x},`);
                  } else {
                    const _first = item_lines[0];
                    const _last = item_lines[item_lines.length - 1 | 0];
                    const _x_end = item_lines.length - 1 | 0;
                    _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(out, `${_M0MPC16string6String6repeat(" ", 2)}${_first}`);
                    const _bind$2 = _x_end - 1 | 0;
                    let _tmp$2 = 0;
                    while (true) {
                      const _$2 = _tmp$2;
                      if (_$2 < _bind$2) {
                        const mid = item_lines[1 + _$2 | 0];
                        _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(out, `${_M0MPC16string6String6repeat(" ", 2)}${mid}`);
                        _tmp$2 = _$2 + 1 | 0;
                        continue;
                      } else {
                        break;
                    ...
                    _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(out, `${_M0MPC16string6String6repeat(" ", 2)}${_last},`);
                  }
                }
                _tmp = _ + 1 | 0;
                continue;
            ...
            _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(out, end);
            return out;
          }
        }
      }
...
function _M0MPC15debug4Repr19prune__info_2einnerN2goS259(replacement, d, node) {
  ...
  if (d <= 0) {
    return _M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(children) ? node : !_M0MPC15debug4Repr17info__adds__depth(node) ? _M0MPC15debug4Repr14with__children(node, _M0MPC15array5Array3mapGRPC15debug4ReprRPC15debug4ReprE(children, (child) => _M0MPC15debug4Repr19prune__info_2einnerN2goS259(replacement, d, child))) : replacement;
  } else {
    if (_M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(children)) {
      return node;
    } else {
      ...
      if (children.length === 2) {
        ...
        if (_bind.length === 0) {
          ...
          if (_bind.length === 1) {
            ...
            const _self = [];
            _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_self, head);
      ...
      if (children.length === 1) {
        ...
        if (_bind.length === 0) {
          ...
          if (_bind.length === 1) {
            ...
            const _self = [];
            _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_self, `${_name$3}=${_first}`);
            _M0MPC15array5Array10push__iterGsE(_self, _M0MPC15array9ArrayView4iterGsE(_x$6));
            return _M0FPC15debug10no__parens(_M0FPC15debug15content__parens(_tmp$2, _self));
          }
        }
      ...
      if (children.length === 1) {
        ...
        if (_bind.length === 0) {
          ...
          if (_bind.length === 1) {
            ...
            const _self = [];
            _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_self, `${label}: ${_first}`);
            _M0MPC15array5Array10push__iterGsE(_self, _M0MPC15array9ArrayView4iterGsE(_x$6));
            return _M0FPC15debug10no__parens(_M0FPC15debug15content__parens(_tmp$2, _self));
          }
        }
  ...
  if (has_digits) {
    ...
    _L$2: {
      ...
      _L$4: {
        ...
        const _bind = _M0FPC28internal7strconv11syntax__errGmE();
        if (_bind.$tag === 1) {
          const _ok = _bind;
          rest$3 = _ok._0;
        } else {
...
function _M0FPC14json13decode__errorGjE(path, msg) {
  return new _M0DTPC16result6ResultGjRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: path, _1: msg }));
}
...
function _M0FPC14json13decode__errorGRPB5ArrayGiEE(path, msg) {
  return new _M0DTPC16result6ResultGRPB5ArrayGiERPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: path, _1: msg }));
}
...
function _M0MPC14json12ParseContext12parse__array(ctx, remaining_available_depth) {
  ...
  _L: while (true) {
    ...
    if (x.$tag === 8) {
      ...
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(vec, _tmp$4);
  ...
  while (true) {
    if (cache.length <= level) {
      if (cache.length >= 1) {
        ...
        _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(cache, `${_last}${_M0MPC16string6String6repeat(" ", indent)}`);
      } else {
        _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(cache, "\n");
      }
      continue;
    } else {
      break;
      ...
      switch (_value.$tag) {
        case 6: {
          ...
          if (_M0MPB3Map9is__emptyGsRPB4JsonE(_members)) {
            ...
            _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(stack, new _M0DTPC14json10WriteFrame6Object(_M0MPB3Map4iterGsRPB4JsonE(_members), true));
          }
          break;
        }
        case 5: {
          const _Array = _value;
          const _arr = _Array._0;
          if (_M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(_arr)) {
            _M0IPB13StringBuilderPB6Logger13write__string(buf, "[]");
          } else {
            depth = depth + 1 | 0;
            ...
            _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(stack, new _M0DTPC14json10WriteFrame5Array(_arr, 0));
          }
          break;
        }
        case 4: {
...
function _M0FPC14json18from__json_2einnerGjE(json, path) {
  return _M0IPC14uint4UIntPC14json8FromJson10from__json(json, path);
}
function _M0FPC14json18from__json_2einnerGiE(json, path) {
  return _M0IPC13int3IntPC14json8FromJson10from__json(json, path);
}
function _M0FPC14json18from__json_2einnerGRPB5ArrayGiEE(json, path) {
  return _M0IPC15array5ArrayPC14json8FromJson10from__jsonGiE(json, path);
}
...
function _M0FPC14json10from__jsonGjE(json, path$46$opt) {
  let path;
  ...
  return _M0FPC14json18from__json_2einnerGjE(json, path);
}
...
function _M0FPC14json10from__jsonGRPB5ArrayGiEE(json, path$46$opt) {
  let path;
  if (path$46$opt === undefined) {
    path = _M0DTPC14json8JsonPath4Root__;
  } else {
  ...
  return _M0FPC14json18from__json_2einnerGRPB5ArrayGiEE(json, path);
}
...
function _M0IPC14uint4UIntPC14json8FromJson10from__json(json, path) {
  _L: {
    if (json.$tag === 3) {
      const _Number = json;
      const _n = _Number._0;
      if (_n !== _M0FPC16double8infinity) {
        if (_n !== _M0FPC16double13neg__infinity) {
          if (_n < 0 || _n > 4294967295) {
            const _bind = _M0FPC14json13decode__errorGuE(path, "UInt::from_json: overflow");
            if (_bind.$tag === 1) {
              const _ok = _bind;
              _ok._0;
            } else {
          ...
          return new _M0DTPC16result6ResultGjRPC14json15JsonDecodeErrorE2Ok(_M0MPC16double6Double8to__uint(_n));
        } else {
          break _L;
        }
      } else {
  ...
  return _M0FPC14json13decode__errorGjE(path, "UInt::from_json: expected number");
}
...
function _M0IPC15array5ArrayPC14json8FromJson10from__jsonGiE(json, path) {
  if (json.$tag === 5) {
    const _Array = json;
    const _a = _Array._0;
    ...
    if (_bind.$tag === 2) {
      ...
      while (true) {
        ...
        if (i < _bind$2) {
          const x = _a[i];
          _Index._1 = i;
          const _bind$3 = _M0IPC13int3IntPC14json8FromJson10from__json(x, _Index);
          let _tmp$3;
          if (_bind$3.$tag === 1) {
            const _ok = _bind$3;
            _tmp$3 = _ok._0;
          ...
          _M0MPC15array5Array4pushGiE(_acc, _tmp$3);
          _tmp$2 = i + 1 | 0;
          continue;
        } else {
          _tmp = _acc;
      ...
      return new _M0DTPC16result6ResultGRPB5ArrayGiERPC14json15JsonDecodeErrorE2Ok(_tmp);
    } else {
      return new _M0DTPC16result6ResultGRPB5ArrayGiERPC14json15JsonDecodeErrorE2Ok($panic());
    }
  } else {
    ...
    if (_bind.$tag === 2) {
      ...
      while (true) {
        ...
        if (i < _bind$2) {
          ...
          _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(_acc, _tmp$3);
          _tmp$2 = i + 1 | 0;
          continue;
        } else {
          _tmp = _acc;
...
function _M0IP211localreview5faker9FakeErrorPC15debug5Debug8to__reprGRP211localreview5faker9FakeErrorE(_x_280) {
  let _arg_281;
  _L: {
    const _Invalid = _x_280;
    const _$42$arg_281 = _Invalid._0;
    _arg_281 = _$42$arg_281;
    break _L;
  }
  return _M0MPC15debug4Repr4ctor("Invalid", [{ _0: undefined, _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_arg_281) }]);
}
function _M0IP211localreview5faker7ProfilePC15debug5Debug8to__repr(_x_272) {
  const _bind = [{ _0: "name", _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_x_272.name) }, { _0: "email", _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_x_272.email) }, { _0: "address", _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_x_272.address) }, { _0: "birth_date", _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_x_272.birth_date) }, { _0: "id", _1: _M0IPC16string6StringPC15debug5Debug8to__repr(_x_272.id) }];
...
function _M0MP211localreview5faker9Generator4date(self, first_year, last_year) {
  ...
  const _bind = _M0MP211localreview5faker9Generator7integer(self, first_year, last_year);
  let y;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    y = _ok._0;
  ...
  const _bind$2 = _M0MP211localreview5faker9Generator7integer(self, 1, 12);
  let m;
  if (_bind$2.$tag === 1) {
    const _ok = _bind$2;
    m = _ok._0;
  ...
  const _tmp = y < 10 ? "000" : y < 100 ? "00" : y < 1000 ? "0" : "";
  const _tmp$2 = _M0MPC13int3Int18to__string_2einner(y, 10);
  const _tmp$3 = _M0FP211localreview5faker3pad(m);
  const _bind$3 = _M0MP211localreview5faker9Generator7integer(self, 1, days);
  let _tmp$4;
  if (_bind$3.$tag === 1) {
    const _ok = _bind$3;
    _tmp$4 = _ok._0;
...
function _M0MP211localreview5faker9Generator7profile(self, index) {
  ...
  const _bind = _M0MP211localreview5faker9Generator7integer(self, 1, 999);
  let _tmp;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _tmp = _ok._0;
  ...
  const address = `${place}${road}${_M0MPC13int3Int18to__string_2einner(_tmp, 10)}号`;
  ...
  const _tmp$2 = `sample${_M0MPC13int3Int18to__string_2einner(index, 10)}@example.test`;
  const _bind$2 = _M0MP211localreview5faker9Generator4date(self, 1970, 2005);
  let _tmp$3;
  if (_bind$2.$tag === 1) {
    const _ok = _bind$2;
    _tmp$3 = _ok._0;
  ...
  return new _M0DTPC16result6ResultGRP211localreview5faker7ProfileRP211localreview5faker9FakeErrorE2Ok(new _M0TP211localreview5faker7Profile(name, _tmp$2, address, _tmp$3, id));
}
...
function _M0FP211localreview5faker14choice__values(values) {
  if (_M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(values) || values.length > 10000) {
...
function _M0FP211localreview5faker11year__start(year) {
  ...
  const _tmp = Math.imul(365, previous) | 0;
  if (4 === 0) {
    $panic();
  }
  const _tmp$2 = _tmp + (previous / 4 | 0) | 0;
  if (100 === 0) {
    $panic();
  }
  const _tmp$3 = _tmp$2 - (previous / 100 | 0) | 0;
  if (400 === 0) {
    $panic();
  }
  return _tmp$3 + (previous / 400 | 0) | 0;
}
function _M0FP211localreview5faker7ordinal(text) {
  ...
  const _bind$2 = "-";
  const fields = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPC16string6String5split(text, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length)));
  let year;
  let _try_err;
  _L: {
    _L$2: {
      const _bind$3 = _M0FPC28internal7strconv18parse__int_2einner(_M0MPC15array5Array2atGRPC16string10StringViewE(fields, 0), 0);
      if (_bind$3.$tag === 1) {
        const _ok = _bind$3;
        year = _ok._0;
      } else {
  ...
  _L$2: {
    _L$3: {
      const _bind$3 = _M0FPC28internal7strconv18parse__int_2einner(_M0MPC15array5Array2atGRPC16string10StringViewE(fields, 1), 0);
      if (_bind$3.$tag === 1) {
        const _ok = _bind$3;
        month = _ok._0;
      } else {
  ...
  _L$3: {
    _L$4: {
      const _bind$3 = _M0FPC28internal7strconv18parse__int_2einner(_M0MPC15array5Array2atGRPC16string10StringViewE(fields, 2), 0);
      if (_bind$3.$tag === 1) {
        const _ok = _bind$3;
        day = _ok._0;
      } else {
...
function _M0MP211localreview5faker8Provider8validate(self) {
  ...
  _L: {
    ...
    _L$2: {
      ...
      _L$3: {
            ...
            _L$6: {
              ...
              _L$7: {
                ...
                _L$8: {
                  ...
                  _L$9: {
                    ...
                    _L$10: {
                      switch (self.$tag) {
                        case 15: {
                          const _Integer = self;
                          const _min = _Integer._0;
                          const _max = _Integer._1;
                          min$2 = _min;
                          max$2 = _max;
                          break _L$10;
                        }
                        case 16: {
                          const _Decimal = self;
                          const _min$2 = _Decimal._0;
                          const _max$2 = _Decimal._1;
                          const _places = _Decimal._2;
                          max = _max$2;
                          min = _min$2;
                          places = _places;
                          break _L$9;
                        ...
                        case 17: {
                          const _DateBetween = self;
                          const _first = _DateBetween._0;
                          const _last = _DateBetween._1;
                          first = _first;
                          last = _last;
                          break _L$8;
                        }
                        case 13: {
                          const _Sentence = self;
                          const _n = _Sentence._0;
                          n$2 = _n;
                          break _L$7;
                        }
                        case 14: {
                          const _Boolean = self;
                          const _n$2 = _Boolean._0;
                          n = _n$2;
                          break _L$6;
                        }
                        case 21: {
                          const _Choice = self;
                          const _values = _Choice._0;
                          values$2 = _values;
                          break _L$5;
                        }
                        case 22: {
                          const _WeightedChoice = self;
                          const _values$2 = _WeightedChoice._0;
                          const _weights = _WeightedChoice._1;
                          values = _values$2;
                          weights = _weights;
                          break _L$4;
                        }
                        case 20: {
                          ...
                          const _template = _Template._0;
                          template = _template;
                          break _L$3;
                        }
                        case 23: {
                          const _Constant = self;
                          const _value = _Constant._0;
                          value = _value;
                          break _L$2;
                        }
                        case 24: {
                          const _Sequence = self;
                          const _start = _Sequence._0;
                          const _step = _Sequence._1;
                          start = _start;
                          step = _step;
                          break _L;
                        }
                  ...
                  const _bind = _M0FP211localreview5faker6bounds(min, max);
                  if (_bind.$tag === 1) {
                    const _ok = _bind;
                    _ok._0;
                  } else {
                ...
                const _bind = _M0FP211localreview5faker7ordinal(first);
                let _tmp;
                if (_bind.$tag === 1) {
                  const _ok = _bind;
                  _tmp = _ok._0;
                ...
                const _tmp$2 = _tmp;
                const _bind$2 = _M0FP211localreview5faker7ordinal(last);
                let _tmp$3;
                if (_bind$2.$tag === 1) {
                  const _ok = _bind$2;
                  _tmp$3 = _ok._0;
        ...
        const _bind = _M0FP211localreview5faker14choice__values(values);
        if (_bind.$tag === 1) {
          const _ok = _bind;
          _ok._0;
        } else {
        ...
        const _bind$2 = _M0FP211localreview5faker13weight__total(weights);
        if (_bind$2.$tag === 1) {
          const _ok = _bind$2;
          _ok._0;
        } else {
      ...
      while (true) {
        ...
        if (_string_index < _bind) {
          ...
          let _decoded_char;
          _L$4: {
            const _bind$2 = template.charCodeAt(_string_index);
            if (_bind$2 >= 55296 && _bind$2 <= 56319 && (_string_index + 1 | 0) < _bind) {
              const _bind$3 = template.charCodeAt(_string_index + 1 | 0);
              if (_bind$3 >= 56320 && _bind$3 <= 57343) {
                _decoded_next_string_index = _string_index + 2 | 0;
                _decoded_char = _M0MPC13int3Int16unsafe__to__char((((Math.imul(_bind$2 - 55296 | 0, 1024) | 0) + _bind$3 | 0) - 56320 | 0) + 65536 | 0);
                break _L$4;
    ...
    const _bind = _M0FP211localreview5faker6scalar(value);
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _ok._0;
    } else {
  ...
  const _bind = _M0FP211localreview5faker6bounds(start, start);
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _ok._0;
  } else {
...
function _M0MP211localreview5faker9Generator15boolean_2einner(self, percent) {
  ...
  const _bind = _M0MP211localreview5faker9Generator7integer(self, 1, 100);
  let _tmp;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _tmp = _ok._0;
  ...
  return new _M0DTPC16result6ResultGbRP211localreview5faker9FakeErrorE2Ok(_tmp <= percent);
}
    ...
    if (_ < _bind) {
      ...
      if (escaped.val) {
        ...
        if (c === 92) {
          ...
          if (c === 35) {
            const _tmp$2 = result.val;
            const _bind$2 = _M0MP211localreview5faker9Generator7integer(self, 0, 9);
            let _tmp$3;
            if (_bind$2.$tag === 1) {
              const _ok = _bind$2;
              _tmp$3 = _ok._0;
            ...
            result.val = `${_tmp$2}${_M0MPC13int3Int18to__string_2einner(_tmp$3, 10)}`;
          } else {
            if (c === 63) {
              const _tmp$2 = result.val;
              const _bind$2 = _M0MP211localreview5faker9Generator7integer(self, 0, 25);
              let _tmp$3;
              if (_bind$2.$tag === 1) {
                const _ok = _bind$2;
                _tmp$3 = _ok._0;
              ...
              result.val = `${_tmp$2}${_M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(alphabet, _tmp$3))}`;
            } else {
              result.val = `${result.val}${_M0IPC14char4CharPB4Show10to__string(c)}`;
            }
          }
...
function _M0MP211localreview5faker9Generator6chooseGsE(self, items) {
  if (_M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(items) || items.length > 100000) {
    return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE3Err(new _M0DTPC15error5Error41localreview_2ffaker_2eFakeError_2eInvalid("choice length 1..100000 required"));
  }
  const _bind = _M0MP211localreview5faker9Generator7integer(self, 0, items.length - 1 | 0);
  let _tmp;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _tmp = _ok._0;
  ...
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(_M0MPC15array5Array2atGRPC16string10StringViewE(items, _tmp));
}
...
function _M0FP211localreview5faker13from__ordinal(days) {
  ...
  const year = new _M0TPB8MutLocalGsE(_M0MPC13int3Int18to__string_2einner(lo.val, 10));
  while (true) {
...
function _M0MP211localreview5faker9Generator13date__between(self, first, last) {
  ...
  const _bind$3 = _M0MP211localreview5faker9Generator7integer(self, _tmp$2, _tmp$3);
  let _tmp$4;
  if (_bind$3.$tag === 1) {
    const _ok = _bind$3;
    _tmp$4 = _ok._0;
  ...
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(_M0FP211localreview5faker13from__ordinal(_tmp$4));
}
function _M0MP211localreview5faker9Generator7decimal(self, min_scaled, max_scaled, places) {
  ...
  const _bind = _M0MP211localreview5faker9Generator7integer(self, min_scaled, max_scaled);
  let number;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    number = _ok._0;
  ...
  const magnitude = number < 0 ? -number | 0 : number;
  const scale = new _M0TPB8MutLocalGiE(1);
  const _bind$2 = 0;
  let _tmp = _bind$2;
  while (true) {
    const _ = _tmp;
    if (_ < places) {
      scale.val = Math.imul(scale.val, 10) | 0;
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _tmp$2 = scale.val;
  if (_tmp$2 === 0) {
    $panic();
  }
  const fraction = new _M0TPB8MutLocalGsE(_M0MPC13int3Int18to__string_2einner(magnitude % _tmp$2 | 0, 10));
  while (true) {
    if (fraction.val.length < places) {
      fraction.val = `0${fraction.val}`;
      continue;
    } else {
      break;
    }
  ...
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(`${sign}${_M0MPC13int3Int18to__string_2einner(magnitude / _tmp$3 | 0, 10)}.${fraction.val}`);
}
function _M0FP211localreview5faker17ean13__from__body(body) {
  ...
  while (true) {
    ...
    if (i < _bind) {
      ...
      sum.val = _tmp$2 + (Math.imul(_tmp$3, _tmp$4) | 0) | 0;
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP211localreview5faker9Generator5ean13(self) {
  const _bind = _M0MP211localreview5faker9Generator7bothify(self, "############");
  let _tmp;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _tmp = _ok._0;
  ...
  return _M0FP211localreview5faker17ean13__from__body(_tmp);
}
function _M0MP211localreview5faker9Generator8username(self) {
  ...
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(`user_${_tmp}`);
}
function _M0MP211localreview5faker9Generator5email(self) {
  const _bind = _M0MP211localreview5faker9Generator8username(self);
  let _tmp;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _tmp = _ok._0;
  ...
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(`${_tmp}@example.test`);
}
function _M0FP211localreview5faker9hex__byte(value) {
  ...
  const _tmp = _M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(digits, value / 16 | 0));
  if (16 === 0) {
    $panic();
  }
  return `${_tmp}${_M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(digits, value % 16 | 0))}`;
}
function _M0MP211localreview5faker9Generator10hex__color(self) {
  const _bind = _M0MPC15array5Array5makeiGsEHRP211localreview5faker9FakeError(3, (_discard_) => {
    const _bind$2 = _M0MP211localreview5faker9Generator7integer(self, 0, 255);
    let _tmp;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      _tmp = _ok._0;
    ...
    return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(_M0FP211localreview5faker9hex__byte(_tmp));
  });
  let _tmp;
  if (_bind.$tag === 1) {
    const _ok = _bind;
  ...
  const _tmp$2 = _tmp;
  const _bind$2 = "";
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(`#${_M0MPC15array5Array4joinGsE(_tmp$2, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length))}`);
}
function _M0MP211localreview5faker9Generator4ipv4(self) {
  const _bind = _M0MP211localreview5faker9Generator6chooseGsE(self, ["192.0.2.", "198.51.100.", "203.0.113."]);
  let _tmp;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _tmp = _ok._0;
  ...
  const _tmp$2 = _tmp;
  const _bind$2 = _M0MP211localreview5faker9Generator7integer(self, 1, 254);
  let _tmp$3;
  if (_bind$2.$tag === 1) {
    const _ok = _bind$2;
    _tmp$3 = _ok._0;
  ...
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(`${_tmp$2}${_M0MPC13int3Int18to__string_2einner(_tmp$3, 10)}`);
}
function _M0MP211localreview5faker9Generator4ipv6(self) {
  ...
  while (true) {
    const _ = _tmp;
    if (_ < _bind$2) {
      const _bind$3 = _M0MP211localreview5faker9Generator7integer(self, 0, 255);
      let _tmp$2;
      if (_bind$3.$tag === 1) {
        const _ok = _bind$3;
        _tmp$2 = _ok._0;
      ...
      const _tmp$3 = _M0FP211localreview5faker9hex__byte(_tmp$2);
      ...
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(groups, `${_tmp$3}${_M0FP211localreview5faker9hex__byte(_tmp$4)}`);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _bind$3 = ":";
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(_M0MPC15array5Array4joinGsE(groups, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length)));
}
function _M0MP211localreview5faker9Generator6isbn13(self) {
  ...
  return _M0FP211localreview5faker17ean13__from__body(`978${_tmp}`);
}
...
function _M0MP211localreview5faker9Generator12mac__address(self) {
  const _bind = _M0MPC15array5Array5makeiGiEHRP211localreview5faker9FakeError(6, (_discard_) => _M0MP211localreview5faker9Generator7integer(self, 0, 255));
  let bytes;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    bytes = _ok._0;
  ...
  const _tmp = _M0MPC15array5Array3mapGisE(bytes, _M0FP211localreview5faker9hex__byte);
  const _bind$2 = ":";
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(_M0MPC15array5Array4joinGsE(_tmp, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length)));
}
...
function _M0MP211localreview5faker9Generator16sentence_2einner(self, words) {
  ...
  const _tmp = _M0MPC15array5Array5makeiGsE(words, (_discard_) => _M0MP211localreview5faker9Generator4word(self));
  const _bind = "，";
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(`${_M0MPC15array5Array4joinGsE(_tmp, new _M0TPC16string10StringView(_bind, 0, _bind.length))}。`);
}
function _M0MP211localreview5faker9Generator3url(self) {
  ...
  const _tmp$2 = _tmp;
  const _bind$2 = _M0MP211localreview5faker9Generator7bothify(self, "??????");
  let _tmp$3;
  if (_bind$2.$tag === 1) {
    const _ok = _bind$2;
    _tmp$3 = _ok._0;
  ...
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(`https://sample-${_tmp$2}.example.test/${_tmp$3}`);
}
function _M0MP211localreview5faker9Generator5uuid4(self) {
  const _bind = _M0MPC15array5Array5makeiGiEHRP211localreview5faker9FakeError(16, (_discard_) => _M0MP211localreview5faker9Generator7integer(self, 0, 255));
  let bytes;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    bytes = _ok._0;
  ...
  _M0MPC15array5Array3setGiE(bytes, 6, _M0MPC15array5Array2atGiE(bytes, 6) & 15 | 64);
  _M0MPC15array5Array3setGiE(bytes, 8, _M0MPC15array5Array2atGiE(bytes, 8) & 63 | 128);
...
function _M0MP211localreview5faker9Generator15weighted__index(self, weights) {
  const _bind = _M0FP211localreview5faker13weight__total(weights);
  let _tmp;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _tmp = _ok._0;
  ...
  const _bind$2 = _M0MP211localreview5faker9Generator7integer(self, 0, _tmp - 1 | 0);
  let _tmp$2;
  if (_bind$2.$tag === 1) {
    const _ok = _bind$2;
    _tmp$2 = _ok._0;
  ...
  const value = new _M0TPB8MutLocalGiE(_tmp$2);
...
function _M0MP211localreview5faker9Generator7provide(self, provider, index) {
  ...
  _L: {
    ...
    _L$2: {
      ...
      _L$3: {
        ...
        _L$4: {
          ...
          _L$5: {
            ...
            _L$6: {
              ...
              _L$7: {
                ...
                _L$8: {
                  ...
                  _L$9: {
                    ...
                    _L$10: {
                      switch (provider.$tag) {
                        ...
                        case 1: {
                          const _bind = _M0MP211localreview5faker9Generator7profile(self, index);
                          let _tmp;
                          if (_bind.$tag === 1) {
                            const _ok = _bind;
                            _tmp = _ok._0;
                          ...
                          return new _M0DTPC16result6ResultGRPB4JsonRP211localreview5faker9FakeErrorE2Ok(_M0MPC14json4Json6string(_tmp.address));
                        }
                        case 2: {
                          const _bind$2 = _M0MP211localreview5faker9Generator5email(self);
                          let _tmp$2;
                          if (_bind$2.$tag === 1) {
                            const _ok = _bind$2;
                            _tmp$2 = _ok._0;
                        ...
                        case 4: {
                          const _bind$4 = _M0MP211localreview5faker9Generator3url(self);
                          let _tmp$4;
                          if (_bind$4.$tag === 1) {
                            const _ok = _bind$4;
                            _tmp$4 = _ok._0;
                        ...
                        case 5: {
                          const _bind$5 = _M0MP211localreview5faker9Generator5uuid4(self);
                          let _tmp$5;
                          if (_bind$5.$tag === 1) {
                            const _ok = _bind$5;
                            _tmp$5 = _ok._0;
                        ...
                        case 6: {
                          const _bind$6 = _M0MP211localreview5faker9Generator4ipv4(self);
                          let _tmp$6;
                          if (_bind$6.$tag === 1) {
                            const _ok = _bind$6;
                            _tmp$6 = _ok._0;
                        ...
                        case 7: {
                          const _bind$7 = _M0MP211localreview5faker9Generator4ipv6(self);
                          let _tmp$7;
                          if (_bind$7.$tag === 1) {
                            const _ok = _bind$7;
                            _tmp$7 = _ok._0;
                        ...
                        case 8: {
                          const _bind$8 = _M0MP211localreview5faker9Generator12mac__address(self);
                          let _tmp$8;
                          if (_bind$8.$tag === 1) {
                            const _ok = _bind$8;
                            _tmp$8 = _ok._0;
                        ...
                        case 9: {
                          const _bind$9 = _M0MP211localreview5faker9Generator10hex__color(self);
                          let _tmp$9;
                          if (_bind$9.$tag === 1) {
                            const _ok = _bind$9;
                            _tmp$9 = _ok._0;
                        ...
                        case 14: {
                          const _Boolean = provider;
                          const _percent = _Boolean._0;
                          percent = _percent;
                          break _L$9;
                        }
                        case 15: {
                          const _Integer = provider;
                          const _min = _Integer._0;
                          const _max = _Integer._1;
                          min$2 = _min;
                          max$2 = _max;
                        ...
                        case 18: {
                          const _bind$10 = _M0MP211localreview5faker9Generator5ean13(self);
                          let _tmp$10;
                          if (_bind$10.$tag === 1) {
                            const _ok = _bind$10;
                            _tmp$10 = _ok._0;
                        ...
                        case 19: {
                          const _bind$11 = _M0MP211localreview5faker9Generator6isbn13(self);
                          let _tmp$11;
                          if (_bind$11.$tag === 1) {
                            const _ok = _bind$11;
                            _tmp$11 = _ok._0;
                        ...
                        case 21: {
                          const _Choice = provider;
                          const _values = _Choice._0;
                          values$2 = _values;
                          break _L$4;
                        }
                        case 22: {
                          const _WeightedChoice = provider;
                          const _values$2 = _WeightedChoice._0;
                          const _weights = _WeightedChoice._1;
                          values = _values$2;
                          weights = _weights;
                        ...
                        case 23: {
                          const _Constant = provider;
                          const _value = _Constant._0;
                          value = _value;
                          break _L$2;
                        }
                        default: {
                          const _Sequence = provider;
                          const _start = _Sequence._0;
                          const _step = _Sequence._1;
                          start = _start;
                          step = _step;
                    ...
                    const _bind = _M0MP211localreview5faker9Generator16sentence_2einner(self, n);
                    let _tmp;
                    if (_bind.$tag === 1) {
                      const _ok = _bind;
                      _tmp = _ok._0;
                    ...
                    return new _M0DTPC16result6ResultGRPB4JsonRP211localreview5faker9FakeErrorE2Ok(_M0MPC14json4Json6string(_tmp));
                  }
                  const _bind = _M0MP211localreview5faker9Generator15boolean_2einner(self, percent);
                  let _tmp;
                  if (_bind.$tag === 1) {
                    const _ok = _bind;
                    _tmp = _ok._0;
                  ...
                  return new _M0DTPC16result6ResultGRPB4JsonRP211localreview5faker9FakeErrorE2Ok(_M0MPC14json4Json7boolean(_tmp));
                }
                const _bind = _M0MP211localreview5faker9Generator7integer(self, min$2, max$2);
                let _tmp;
                if (_bind.$tag === 1) {
                  const _ok = _bind;
                  _tmp = _ok._0;
                ...
                return new _M0DTPC16result6ResultGRPB4JsonRP211localreview5faker9FakeErrorE2Ok(_M0IPC13int3IntPB6ToJson8to__json(_tmp));
              }
              const _bind = _M0MP211localreview5faker9Generator7decimal(self, min, max, places);
              let _tmp;
              if (_bind.$tag === 1) {
                const _ok = _bind;
                _tmp = _ok._0;
            ...
            const _bind = _M0MP211localreview5faker9Generator13date__between(self, first, last);
            let _tmp;
            if (_bind.$tag === 1) {
              const _ok = _bind;
              _tmp = _ok._0;
          ...
          const _bind = _M0MP211localreview5faker9Generator7bothify(self, template);
          let _tmp;
          if (_bind.$tag === 1) {
            const _ok = _bind;
            _tmp = _ok._0;
        ...
        const _bind = _M0MP211localreview5faker9Generator6chooseGsE(self, values$2);
        let _tmp;
        if (_bind.$tag === 1) {
          const _ok = _bind;
          _tmp = _ok._0;
      ...
      const _bind = _M0MP211localreview5faker9Generator15weighted__index(self, weights);
      let _tmp;
      if (_bind.$tag === 1) {
        const _ok = _bind;
        _tmp = _ok._0;
      ...
      return new _M0DTPC16result6ResultGRPB4JsonRP211localreview5faker9FakeErrorE2Ok(_M0MPC14json4Json6string(_M0MPC15array5Array2atGRPC16string10StringViewE(values, _tmp)));
    }
    return _M0FP211localreview5faker6scalar(value);
  }
  const _bind = _M0FP211localreview5faker15sequence__value(start, step, index);
  let _tmp;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    _tmp = _ok._0;
...
function _M0FP211localreview5faker7records(seed, columns, count) {
  if (count < 0 || (count > 10000 || (_M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(columns) || (columns.length > 32 || (Math.imul(count, columns.length) | 0) > 100000)))) {
  ...
  const _bind = [];
  const names = _M0MPB3Map3MapGsbE(new _M0TPB9ArrayViewGUsbEE(_bind, 0, 0), undefined);
  const seen = [];
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      ...
      const _bind$3 = _M0MP211localreview5faker8Provider8validate(column.provider);
      if (_bind$3.$tag === 1) {
        const _ok = _bind$3;
        _ok._0;
      } else {
      ...
      _L: {
        _L$2: {
          const _bind$4 = column.provider;
          if (_bind$4.$tag === 24) {
            const _Sequence = _bind$4;
            const _start = _Sequence._0;
            const _step = _Sequence._1;
            start = _start;
            step = _step;
        ...
        const _bind$4 = _M0FP211localreview5faker15sequence__value(start, step, count > 0 ? count - 1 | 0 : 0);
        if (_bind$4.$tag === 1) {
          const _ok = _bind$4;
          _ok._0;
        } else {
      ...
      const _bind$4 = [];
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(seen, _M0MPB3Map3MapGsbE(new _M0TPB9ArrayViewGUsbEE(_bind$4, 0, 0), undefined));
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    ...
    if (index < count) {
      const _bind$4 = [];
      const row = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$4, 0, 0), undefined);
      ...
      while (true) {
        ...
        if (c < _bind$5) {
          ...
          const accepted = new _M0TPB8MutLocalGbE(false);
          const _bind$6 = 0;
          const _bind$7 = 1000;
          let _tmp$4 = _bind$6;
          while (true) {
            ...
            if (_ < _bind$7) {
              _L: {
                ...
                if (column.null_percent > 0) {
                  const _bind$8 = _M0MP211localreview5faker9Generator15boolean_2einner(generator, column.null_percent);
                  let _tmp$6;
                  if (_bind$8.$tag === 1) {
                    const _ok = _bind$8;
                    _tmp$6 = _ok._0;
                ...
                if (_tmp$5) {
                  ...
                  const _bind$8 = _M0MP211localreview5faker9Generator7provide(generator, column.provider, index);
                  if (_bind$8.$tag === 1) {
                    const _ok = _bind$8;
                    value = _ok._0;
                  } else {
                ...
                const key = _M0MPC14json4Json17stringify_2einner(value, false, 0, undefined);
                if (column.unique && _M0MPB3Map8containsGsbE(_M0MPC15array5Array2atGRPC16string10StringViewE(seen, c), key)) {
                  break _L;
                }
                if (column.unique) {
                  _M0MPB3Map3setGsbE(_M0MPC15array5Array2atGRPC16string10StringViewE(seen, c), key, true);
                }
                _M0MPB3Map3setGsRPB4JsonE(row, column.name, value);
                accepted.val = true;
                break;
              }
              _tmp$4 = _ + 1 | 0;
      ...
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(rows, value);
      _tmp$2 = index + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP211localreview5faker15render__records(columns, rows, format) {
  ...
  if (rows.length > 10000 || (_M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(columns) || (columns.length > 32 || (Math.imul(rows.length, columns.length) | 0) > 100000))) {
  ...
  while (true) {
    ...
    if (_ < _bind$3) {
      const row = rows[_];
      const _bind$4 = _M0FP211localreview5faker6object(row);
      let source;
      if (_bind$4.$tag === 1) {
        const _ok = _bind$4;
        source = _ok._0;
      ...
      const _bind$5 = [];
      const clean = _M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$5, 0, 0), undefined);
      const _bind$6 = columns.length;
      let _tmp$3 = 0;
      while (true) {
        const _$2 = _tmp$3;
        if (_$2 < _bind$6) {
          const column = columns[_$2];
          const _tmp$4 = column.name;
          const _bind$7 = _M0FP211localreview5faker8required(source, column.name);
          let _tmp$5;
          if (_bind$7.$tag === 1) {
            const _ok = _bind$7;
            _tmp$5 = _ok._0;
          ...
          const _bind$8 = _M0FP211localreview5faker6scalar(_tmp$5);
          let _tmp$6;
          if (_bind$8.$tag === 1) {
            const _ok = _bind$8;
            _tmp$6 = _ok._0;
          ...
          _M0MPB3Map3setGsRPB4JsonE(clean, _tmp$4, _tmp$6);
          _tmp$3 = _$2 + 1 | 0;
          continue;
        } else {
          break;
      ...
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(canonical, value);
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  if (format === "jsonl") {
    let _tmp$3;
    if (_M0MPC15array5Array9is__emptyGRP211localreview5faker6ColumnE(canonical)) {
      _tmp$3 = "";
    } else {
      const _tmp$4 = _M0MPC15array5Array3mapGRPB4JsonsE(canonical, (row) => _M0MPC14json4Json17stringify_2einner(row, false, 0, undefined));
      const _bind$4 = "\n";
      _tmp$3 = `${_M0MPC15array5Array4joinGsE(_tmp$4, new _M0TPC16string10StringView(_bind$4, 0, _bind$4.length))}\n`;
    }
  ...
  const quote = (s) => {
    ...
    const _bind$5 = "\"\"";
    return `\"${_M0MPC16string6String12replace__all(s, _tmp$3, new _M0TPC16string10StringView(_bind$5, 0, _bind$5.length))}\"`;
  };
  const _tmp$3 = _M0MPC15array5Array3mapGRP211localreview5faker6ColumnsE(columns, (c) => quote(c.name));
  const _bind$4 = ",";
  const lines = [_M0MPC15array5Array4joinGsE(_tmp$3, new _M0TPC16string10StringView(_bind$4, 0, _bind$4.length))];
  const _bind$5 = canonical.length;
  let _tmp$4 = 0;
  while (true) {
    const _ = _tmp$4;
    if (_ < _bind$5) {
      const row = canonical[_];
      let object;
      if (row.$tag === 6) {
        const _Object = row;
      ...
      while (true) {
        ...
        if (_$2 < _bind$6) {
          ...
          let v;
          _L: {
            const _bind$7 = _M0MPB3Map3getGsRPB4JsonE(object, column.name);
          ...
          const _bind$7 = _M0FP211localreview5faker6scalar(v);
          if (_bind$7.$tag === 1) {
            const _ok = _bind$7;
            value = _ok._0;
          } else {
          ...
          switch (value.$tag) {
            ...
            default: {
              _tmp$6 = _M0MPC14json4Json17stringify_2einner(value, false, 0, undefined);
            }
          }
          _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(cells, quote(_tmp$6));
          _tmp$5 = _$2 + 1 | 0;
          continue;
        } else {
          break;
      ...
      const _bind$7 = ",";
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(lines, _M0MPC15array5Array4joinGsE(cells, new _M0TPC16string10StringView(_bind$7, 0, _bind$7.length)));
      _tmp$4 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _bind$6 = "\r\n";
  return new _M0DTPC16result6ResultGsRP211localreview5faker9FakeErrorE2Ok(`${_M0MPC15array5Array4joinGsE(lines, new _M0TPC16string10StringView(_bind$6, 0, _bind$6.length))}\r\n`);
}
...
function _M0FP211localreview5faker11int__option(fields, key, fallback) {
  ...
  let _try_err;
  _L$2: {
    const _bind = _M0FPC14json10from__jsonGiE(value, undefined);
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    return new _M0DTPC16result6ResultGiRP211localreview5faker9FakeErrorE2Ok(_tmp);
  }
...
function _M0FP211localreview5faker15string__options(fields, key) {
  let _try_err;
  _L: {
    const _bind = _M0FP211localreview5faker8required(fields, key);
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    const _bind$2 = _M0FPC14json10from__jsonGRPB5ArrayGsEE(_tmp, undefined);
    let _tmp$2;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      _tmp$2 = _ok._0;
...
function _M0FP211localreview5faker13parse__column(value) {
  const _bind = _M0FP211localreview5faker6object(value);
  let fields;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    fields = _ok._0;
  ...
  const _bind$2 = _M0FP211localreview5faker12text__option(fields, "name", "");
  let name;
  if (_bind$2.$tag === 1) {
    const _ok = _bind$2;
    name = _ok._0;
  ...
  const _bind$3 = _M0FP211localreview5faker12text__option(fields, "provider", "");
  let kind;
  if (_bind$3.$tag === 1) {
    const _ok = _bind$3;
    kind = _ok._0;
  ...
  const allowed = ["name", "provider", "unique", "null_percent"];
  const _bind$4 = extra.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind$4) {
      const key = extra[_];
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(allowed, key);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _bind$5 = _M0FP211localreview5faker15reject__unknown(fields, allowed);
  if (_bind$5.$tag === 1) {
    const _ok = _bind$5;
    _ok._0;
  } else {
  ...
  switch (kind) {
    ...
    case "sentence": {
      const _bind$6 = _M0FP211localreview5faker11int__option(fields, "words", 6);
      let _tmp$2;
      if (_bind$6.$tag === 1) {
        const _ok = _bind$6;
        _tmp$2 = _ok._0;
      ...
      provider = new _M0DTP211localreview5faker8Provider8Sentence(_tmp$2);
      break;
    }
    case "boolean": {
      const _bind$7 = _M0FP211localreview5faker11int__option(fields, "percent", 50);
      let _tmp$3;
      if (_bind$7.$tag === 1) {
        const _ok = _bind$7;
        _tmp$3 = _ok._0;
      ...
      provider = new _M0DTP211localreview5faker8Provider7Boolean(_tmp$3);
      break;
    }
    case "integer": {
      const _bind$8 = _M0FP211localreview5faker11int__option(fields, "min", 0);
      let _tmp$4;
      if (_bind$8.$tag === 1) {
        const _ok = _bind$8;
        _tmp$4 = _ok._0;
      ...
      const _bind$9 = _M0FP211localreview5faker11int__option(fields, "max", 100);
      let _tmp$5;
      if (_bind$9.$tag === 1) {
        const _ok = _bind$9;
        _tmp$5 = _ok._0;
      ...
      provider = new _M0DTP211localreview5faker8Provider7Integer(_tmp$4, _tmp$5);
      break;
    }
    case "decimal": {
      ...
      const _bind$11 = _M0FP211localreview5faker11int__option(fields, "max", 10000);
      let _tmp$7;
      if (_bind$11.$tag === 1) {
        const _ok = _bind$11;
        _tmp$7 = _ok._0;
      ...
      const _bind$12 = _M0FP211localreview5faker11int__option(fields, "places", 2);
      let _tmp$8;
      if (_bind$12.$tag === 1) {
        const _ok = _bind$12;
        _tmp$8 = _ok._0;
      ...
      provider = new _M0DTP211localreview5faker8Provider7Decimal(_tmp$6, _tmp$7, _tmp$8);
      break;
    }
    case "date": {
      const _bind$13 = _M0FP211localreview5faker12text__option(fields, "first", "2000-01-01");
      let _tmp$9;
      if (_bind$13.$tag === 1) {
        const _ok = _bind$13;
        _tmp$9 = _ok._0;
      ...
      const _bind$14 = _M0FP211localreview5faker12text__option(fields, "last", "2030-12-31");
      let _tmp$10;
      if (_bind$14.$tag === 1) {
        const _ok = _bind$14;
        _tmp$10 = _ok._0;
      ...
      provider = new _M0DTP211localreview5faker8Provider11DateBetween(_tmp$9, _tmp$10);
      break;
    }
    case "ean13": {
    ...
    case "template": {
      const _bind$15 = _M0FP211localreview5faker12text__option(fields, "template", "????-####");
      let _tmp$11;
      if (_bind$15.$tag === 1) {
        const _ok = _bind$15;
        _tmp$11 = _ok._0;
      ...
      provider = new _M0DTP211localreview5faker8Provider8Template(_tmp$11);
      break;
    }
    case "choice": {
      const _bind$16 = _M0FP211localreview5faker15string__options(fields, "values");
      let _tmp$12;
      if (_bind$16.$tag === 1) {
        const _ok = _bind$16;
        _tmp$12 = _ok._0;
      ...
      provider = new _M0DTP211localreview5faker8Provider6Choice(_tmp$12);
      break;
    }
    case "weighted_choice": {
      let weights;
      ...
      _L: {
        _L$2: {
          const _bind$17 = _M0FP211localreview5faker8required(fields, "weights");
          let _tmp$13;
          if (_bind$17.$tag === 1) {
            const _ok = _bind$17;
            _tmp$13 = _ok._0;
          ...
          const _bind$18 = _M0FPC14json10from__jsonGRPB5ArrayGiEE(_tmp$13, undefined);
          if (_bind$18.$tag === 1) {
            const _ok = _bind$18;
            weights = _ok._0;
          } else {
      ...
      const _bind$17 = _M0FP211localreview5faker15string__options(fields, "values");
      let _tmp$13;
      if (_bind$17.$tag === 1) {
        const _ok = _bind$17;
        _tmp$13 = _ok._0;
      ...
      provider = new _M0DTP211localreview5faker8Provider14WeightedChoice(_tmp$13, weights);
      break;
    }
    case "constant": {
      ...
      provider = new _M0DTP211localreview5faker8Provider8Constant(_tmp$14);
      break;
    }
    case "sequence": {
      const _bind$19 = _M0FP211localreview5faker11int__option(fields, "start", 0);
      let _tmp$15;
      if (_bind$19.$tag === 1) {
        const _ok = _bind$19;
        _tmp$15 = _ok._0;
      ...
      const _bind$20 = _M0FP211localreview5faker11int__option(fields, "step", 1);
      let _tmp$16;
      if (_bind$20.$tag === 1) {
        const _ok = _bind$20;
        _tmp$16 = _ok._0;
      ...
      provider = new _M0DTP211localreview5faker8Provider8Sequence(_tmp$15, _tmp$16);
      break;
    }
    default: {
  ...
  const _bind$21 = _M0MPB3Map3getGsRPB4JsonE(fields, "unique");
  let unique;
  ...
  const _bind$22 = _M0FP211localreview5faker11int__option(fields, "null_percent", 0);
  let _tmp$17;
  if (_bind$22.$tag === 1) {
    const _ok = _bind$22;
    _tmp$17 = _ok._0;
  ...
  return new _M0DTPC16result6ResultGRP211localreview5faker6ColumnRP211localreview5faker9FakeErrorE2Ok(_M0MP211localreview5faker6Column11new_2einner(name, provider, unique, _tmp$17));
}
function _M0FP211localreview5faker17generate__request(request) {
  ...
  const _bind = _M0FP211localreview5faker6object(input);
  let fields;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    fields = _ok._0;
  ...
  const _bind$2 = _M0FP211localreview5faker15reject__unknown(fields, ["seed", "count", "columns", "format"]);
  if (_bind$2.$tag === 1) {
    const _ok = _bind$2;
    _ok._0;
  } else {
  ...
  _L$2: {
    ...
    _L$4: {
      _L$5: {
        const _bind$3 = _M0FPC14json10from__jsonGjE(value, undefined);
        if (_bind$3.$tag === 1) {
          const _ok = _bind$3;
          seed = _ok._0;
        } else {
  ...
  const _bind$3 = _M0FP211localreview5faker11int__option(fields, "count", 10);
  let count;
  if (_bind$3.$tag === 1) {
    const _ok = _bind$3;
    count = _ok._0;
  ...
  const _bind$4 = _M0FP211localreview5faker12text__option(fields, "format", "json");
  let format;
  if (_bind$4.$tag === 1) {
    const _ok = _bind$4;
    format = _ok._0;
  ...
  let entries;
  const _bind$5 = _M0FP211localreview5faker8required(fields, "columns");
  let _bind$6;
  if (_bind$5.$tag === 1) {
    const _ok = _bind$5;
    _bind$6 = _ok._0;
  ...
  const columns = [];
  const _bind$7 = entries.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind$7) {
      const column = entries[_];
      const _bind$8 = _M0FP211localreview5faker13parse__column(column);
      let _tmp$2;
      if (_bind$8.$tag === 1) {
        const _ok = _bind$8;
        _tmp$2 = _ok._0;
      ...
      _M0MPC15array5Array4pushGRP211localreview5faker6ColumnE(columns, _tmp$2);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _bind$8 = _M0FP211localreview5faker7records(seed, columns, count);
  let _tmp$2;
  if (_bind$8.$tag === 1) {
    const _ok = _bind$8;
    _tmp$2 = _ok._0;
  ...
  return _M0FP211localreview5faker15render__records(columns, _tmp$2, format);
}
function _M0FP411localreview5faker3cmd3web3run(input) {
  ...
  _L: {
    ...
    if (_M0MPC16string10StringView11has__prefix(_tmp, new _M0TPC16string10StringView(_bind, 0, _bind.length))) {
      const _bind$2 = _M0FP211localreview5faker17generate__request(input);
      let _tmp$2;
      if (_bind$2.$tag === 1) {
        const _ok = _bind$2;
        _tmp$2 = _ok._0;
    ...
    const _bind$2 = " ";
    const p = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB4Iter6filterGRPC16string10StringViewE(_M0MPC16string10StringView5split(_tmp$2, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length)), (s) => !_M0MPC16string10StringView9is__empty(s)));
    if (p.length !== 2) {
      return "ERROR: seed count";
    }
    const _bind$3 = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRPC16string10StringViewE(p, 0));
    const _bind$4 = _M0FPC28internal7strconv19parse__uint_2einner(new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length), 0);
    let _tmp$3;
    if (_bind$4.$tag === 1) {
      const _ok = _bind$4;
      _tmp$3 = _ok._0;
    ...
    const _bind$6 = _M0FPC28internal7strconv18parse__int_2einner(new _M0TPC16string10StringView(_bind$5, 0, _bind$5.length), 0);
    let _tmp$5;
    if (_bind$6.$tag === 1) {
      const _ok = _bind$6;
      _tmp$5 = _ok._0;
    ...
    const _bind$7 = _M0FP211localreview5faker7dataset(_tmp$4, _tmp$5);
    let _tmp$6;
    if (_bind$7.$tag === 1) {
      const _ok = _bind$7;
      _tmp$6 = _ok._0;
    ...
    return _M0IP016_24default__implPB4Show10to__stringGRPC15debug4ReprE(_M0MPC15debug4Repr4ReprGRPB5ArrayGRP211localreview5faker7ProfileEE(_tmp$6));
  }
  const e = _try_err;
...
export { _M0FP411localreview5faker3cmd3web3run as run }
