...
function _M0MPC15debug4Repr6record(fields) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _name = _x._0;
      const _value = _x._1;
      _M0MPC15array5Array4pushGRPC16string10StringViewE(_acc, new _M0DTPC15debug4Repr11RecordField(_name, _value));
      continue;
    }
  }
...
function _M0FP411localreview5faker3cmd3web3run(input) {
  ...
  _L: {
    ...
    const _bind = " ";
    const p = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB4Iter6filterGRPC16string10StringViewE(_M0MPC16string10StringView5split(_tmp, new _M0TPC16string10StringView(_bind, 0, _bind.length)), (s) => !_M0MPC16string10StringView9is__empty(s)));
    if (p.length !== 2) {
      return "ERROR: seed count";
    }
    const _bind$2 = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRPC16string10StringViewE(p, 0));
    const _bind$3 = _M0FPC28internal7strconv19parse__uint_2einner(new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length), 0);
    let _tmp$2;
    if (_bind$3.$tag === 1) {
      const _ok = _bind$3;
      _tmp$2 = _ok._0;
    ...
    const _tmp$3 = _tmp$2;
    const _bind$4 = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRPC16string10StringViewE(p, 1));
    ...
    const _bind$6 = _M0FP211localreview5faker7dataset(_tmp$3, _tmp$4);
    let _tmp$5;
    if (_bind$6.$tag === 1) {
      const _ok = _bind$6;
      _tmp$5 = _ok._0;
    ...
    return _M0IP016_24default__implPB4Show10to__stringGRPC15debug4ReprE(_M0MPC15debug4Repr4ReprGRPB5ArrayGRP211localreview5faker7ProfileEE(_tmp$5));
  }
  const e = _try_err;
